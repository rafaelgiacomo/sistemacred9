...
{
    public class ContratoRelatorioRepositorio : RepositorioBase<ContratoRelatorio>, IContratoRelatorioRepositorio
    {
        public ContratoRelatorioRepositorio(Cred9DbContext context) : base(context) { }
    }
}
